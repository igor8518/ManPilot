...
//#include <graphics.h>
	...
	{
	/*public: ref class GUIExtensions abstract sealed
		{
		public: delegate void InvokeHandler();
		public: static void SafeInvoke(System::Windows::Forms::Control control, InvokeHandler^ handler)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Size = System::Drawing::Size(260, 231);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Connect to the simulator";
			...
			this->vScrollBar2->ValueChanged += gcnew System::EventHandler(this, &MyForm::vScrollBar2_ValueChanged);
			// 
			// vScrollBar3
			// 
			...
			this->vScrollBar3->ValueChanged += gcnew System::EventHandler(this, &MyForm::vScrollBar3_ValueChanged);
			// 
			// vScrollBar4
			// 
			...
			this->vScrollBar4->ValueChanged += gcnew System::EventHandler(this, &MyForm::vScrollBar4_ValueChanged);
			// 
			// vScrollBar5
			// 
			...
			this->vScrollBar5->ValueChanged += gcnew System::EventHandler(this, &MyForm::vScrollBar5_ValueChanged);
			// 
			// vScrollBar6
			// 
			...
			this->vScrollBar6->ValueChanged += gcnew System::EventHandler(this, &MyForm::vScrollBar6_ValueChanged);
			// 
			// panel1
			// 
			...
			this->ClientSize = System::Drawing::Size(601, 552);
...
#pragma endregion
	...
	public: void SetControlSafe(String^ nc, String^ np, Object^ v)
	{
				...
				if (c->InvokeRequired)
				{
					c->BeginInvoke(gcnew  Action<String^, String^, Object^>(this, &MyForm::SetControlSafe), nc, np, v);
				}
				else
				{
					p->SetValue(c, v);
	...
	public: Object^ GetControlSafe(String^ nc, String^ np)
	{
				...
				if (c->InvokeRequired)
				{
					return c->Invoke(gcnew Func<String^, String^, Object^> (this, &MyForm::GetControlSafe), nc, np);
				}
				else
				{
					return p->GetValue(c);
	...
	{
				return MyForm::Controls->Find(NameControl, true)[0];
	}
